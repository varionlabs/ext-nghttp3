...
make test TESTS='tests/100_phase5_ngtcp2_adapter_happy_path.phpt tests/102_phase6_ngtcp2_multi_stream_and_close.phpt tests/103_phase6_ngtcp2_reset_and_goaway.phpt'
```

## 3. Suggested CI split

- Job A (`nghttp3-default`): run the full suite without `ngtcp2` (expects `100/102/103` to SKIP).
- Job B (`nghttp3-with-ngtcp2`): build/load `ext-ngtcp2` and run `100/102/103` as required PASS.
