...
$checks = [
    ...
    class_exists('Varion\\Nghttp3\\Events\\ConnectionEvent'),
    class_exists('Varion\\Nghttp3\\Events\\StreamEvent'),
    class_exists('Varion\\Nghttp3\\Events\\TerminalStreamEvent'),
